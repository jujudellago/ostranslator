...
class User < ApplicationRecord
  ...
  devise :confirmable, :database_authenticatable,:registerable, :lockable,  :recoverable, :rememberable, :timeoutable, :trackable, :validatable
...
#
  ...
  def send_imported_mail_instruction
    token = set_reset_password_token
    BtMailer.imported_instructions(self,token).deliver_now
